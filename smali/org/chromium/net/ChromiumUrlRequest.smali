...
.source "ChromiumUrlRequest.java"
...
.field private final h:Lorg/chromium/net/HttpUrlRequestListener;
...
.method private a(Ljava/lang/Exception;)V
    ...
    .line 541
    :try_start_0
    invoke-virtual {p0}, Lorg/chromium/net/ChromiumUrlRequest;->b()V
    :try_end_0
...
.method private d()V
    ...
    iput v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->u:I
    ...
    iput-object v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->v:Ljava/lang/String;

    .line 498
    iget v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->u:I
    ...
    iput v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->q:I
    ...
    .line 502
    :cond_0
    iget-object v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->h:Lorg/chromium/net/HttpUrlRequestListener;
...
.method private finish()V
    ...
    .line 642
    :try_start_0
    iget-object v1, p0, Lorg/chromium/net/ChromiumUrlRequest;->w:Ljava/lang/Object;
    ...
    :goto_2
    :try_start_4
    invoke-direct {p0}, Lorg/chromium/net/ChromiumUrlRequest;->d()V
...
.method private onBytesRead(Ljava/nio/ByteBuffer;)V
    ...
    .line 603
    :try_start_0
    iget-boolean v1, p0, Lorg/chromium/net/ChromiumUrlRequest;->m:Z
    ...
    .line 608
    iget-wide v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->o:J

    int-to-long v4, v1

    add-long/2addr v2, v4

    iput-wide v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->o:J

    .line 609
    iget-boolean v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->n:Z
    ...
    iput-boolean v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->n:Z

    .line 614
    iget-wide v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->j:J

    iget-wide v4, p0, Lorg/chromium/net/ChromiumUrlRequest;->o:J
    ...
    .line 618
    :cond_2
    iget-wide v2, p0, Lorg/chromium/net/ChromiumUrlRequest;->k:J
    ...
    iget-wide v4, p0, Lorg/chromium/net/ChromiumUrlRequest;->k:J
    ...
    .line 628
    :try_start_1
    invoke-direct {p0}, Lorg/chromium/net/ChromiumUrlRequest;->c()V
    :try_end_1
...
.method private onResponseStarted()V
    ...
    iput-object v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->s:Ljava/lang/String;
    ...
    .line 560
    iget-wide v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->k:J
    ...
    .line 569
    invoke-virtual {p0}, Lorg/chromium/net/ChromiumUrlRequest;->a()Ljava/nio/channels/WritableByteChannel;
    ...
    .line 577
    iget v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->q:I
    ...
    iput-wide v0, p0, Lorg/chromium/net/ChromiumUrlRequest;->o:J
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
