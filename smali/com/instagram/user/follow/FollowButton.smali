...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 49
    sget-object v0, Lcom/facebook/y;->FollowButton:[I
    ...
    .line 51
    sget v1, Lcom/facebook/y;->FollowButton_followButtonStyle:I
    ...
    invoke-virtual {p0, v0}, Lcom/instagram/user/follow/FollowButton;->setBackgroundStyle(Lcom/instagram/user/follow/v;)V
...
.method private a(Landroid/content/Context;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    .locals 7
    ...
    .line 181
    invoke-virtual {p2}, Lcom/instagram/user/a/l;->x()Lcom/instagram/user/a/i;
    ...
    sget v1, Lcom/facebook/r;->unfollow_public_user_x:I
    ...
    sget v1, Lcom/facebook/r;->unfollow_private_user_x:I
    ...
    invoke-direct {v1, p1}, Lcom/instagram/ui/dialog/f;-><init>(Landroid/content/Context;)V
    ...
    sget v1, Lcom/facebook/r;->unfollow:I

    new-instance v2, Lcom/instagram/user/follow/k;

    invoke-direct {v2, p0, p2, p3}, Lcom/instagram/user/follow/k;-><init>(Lcom/instagram/user/follow/FollowButton;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    ...
    new-instance v2, Lcom/instagram/user/follow/j;

    invoke-direct {v2, p0}, Lcom/instagram/user/follow/j;-><init>(Lcom/instagram/user/follow/FollowButton;)V
...
.method static synthetic a(Lcom/instagram/user/follow/FollowButton;Landroid/content/Context;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    .locals 0

    .prologue
    .line 24
    invoke-direct {p0, p1, p2, p3}, Lcom/instagram/user/follow/FollowButton;->a(Landroid/content/Context;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V

    return-void
.end method

.method static synthetic a(Lcom/instagram/user/follow/FollowButton;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    .locals 0

    .prologue
    .line 24
    invoke-direct {p0, p1, p2}, Lcom/instagram/user/follow/FollowButton;->b(Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V

    return-void
.end method

.method private b(Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    .locals 3
    ...
    invoke-virtual {v0, p1, v1}, Lcom/instagram/user/follow/y;->a(Lcom/instagram/user/a/l;Ljava/lang/String;)V
    ...
    .line 171
    invoke-interface {p2, p1}, Lcom/instagram/user/follow/m;->a(Lcom/instagram/user/a/l;)V
...
.method public a(Lcom/instagram/user/a/l;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/instagram/user/follow/FollowButton;->a(Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V

    .line 136
    return-void
.end method

.method public a(Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
    .locals 1
    ...
    .line 143
    :cond_0
    invoke-static {p1}, Lcom/instagram/user/d/a;->a(Lcom/instagram/user/a/l;)Z
    ...
    .line 148
    :cond_1
    invoke-virtual {p0, p1}, Lcom/instagram/user/follow/FollowButton;->b(Lcom/instagram/user/a/l;)V

    .line 150
    new-instance v0, Lcom/instagram/user/follow/i;

    invoke-direct {v0, p0, p1, p2}, Lcom/instagram/user/follow/i;-><init>(Lcom/instagram/user/follow/FollowButton;Lcom/instagram/user/a/l;Lcom/instagram/user/follow/m;)V
...
.method protected b(Lcom/instagram/user/a/l;)V
    .locals 5
    ...
    invoke-virtual {v0, v2}, Lcom/instagram/user/follow/n;->a(Lcom/instagram/user/a/f;)I
    ...
    .line 224
    invoke-static {v2}, Lcom/instagram/user/follow/p;->a(Lcom/instagram/user/a/f;)Lcom/instagram/user/follow/v;
    ...
    invoke-static {v2}, Lcom/instagram/user/follow/p;->c(Lcom/instagram/user/a/f;)I
    ...
    invoke-static {v2}, Lcom/instagram/user/follow/p;->d(Lcom/instagram/user/a/f;)I
    ...
    .line 231
    sget-object v0, Lcom/instagram/user/follow/l;->a:[I
    ...
    invoke-virtual {v0}, Lcom/instagram/user/follow/n;->a()Z
    ...
    .line 233
    :pswitch_0
    sget v1, Lcom/facebook/r;->following_button_loading:I
    ...
    .line 237
    :pswitch_1
    sget v1, Lcom/facebook/r;->following_button_following:I
    ...
    .line 241
    :pswitch_2
    sget v1, Lcom/facebook/r;->following_button_requested:I
    ...
    .line 245
    :pswitch_3
    sget v1, Lcom/facebook/r;->following_button_follow:I
