...
.method private constructor <init>(Lcom/instagram/creation/photo/camera/v;)V
    ...
    .prologue
    .line 1452
    iput-object p1, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;
...
.method synthetic constructor <init>(Lcom/instagram/creation/photo/camera/v;Lcom/instagram/creation/photo/camera/c;)V
    ...
    .prologue
    .line 1452
    invoke-direct {p0, p1}, Lcom/instagram/creation/photo/camera/q;-><init>(Lcom/instagram/creation/photo/camera/v;)V
...
.method private a(Landroid/hardware/Camera;)I
    ...
    .line 1528
    iget-object v1, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;

    invoke-static {v1}, Lcom/instagram/creation/photo/camera/v;->i(Lcom/instagram/creation/photo/camera/v;)I

    move-result v1

    invoke-static {v1}, Lcom/instagram/camera/j;->a(I)Landroid/hardware/Camera$CameraInfo;
    ...
    const-string v2, "cameraRotation: %d"
...
.method public onPictureTaken([BLandroid/hardware/Camera;)V
    ...
    const-string v1, "JpegPictureCallback: jpeg returned with size: %d"
    ...
    .line 1460
    iget-object v0, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;
    ...
    invoke-static {v0}, Lcom/instagram/creation/photo/camera/v;->s(Lcom/instagram/creation/photo/camera/v;)Lcom/instagram/creation/photo/camera/p;

    move-result-object v0

    iget-object v1, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;

    invoke-static {v1}, Lcom/instagram/creation/photo/camera/v;->r(Lcom/instagram/creation/photo/camera/v;)Landroid/location/Location;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/instagram/creation/photo/camera/p;->a([BLandroid/location/Location;III)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/instagram/creation/photo/camera/v;->t(Lcom/instagram/creation/photo/camera/v;)Landroid/net/Uri;
    ...
    invoke-static {v0}, Lcom/instagram/creation/photo/camera/v;->u(Lcom/instagram/creation/photo/camera/v;)V
    ...
    .line 1489
    :cond_1
    invoke-direct {p0, p2}, Lcom/instagram/creation/photo/camera/q;->a(Landroid/hardware/Camera;)I
    ...
    invoke-static {v1}, Lcom/instagram/creation/photo/camera/v;->t(Lcom/instagram/creation/photo/camera/v;)Landroid/net/Uri;
    ...
    iget-object v4, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;

    invoke-static {v4}, Lcom/instagram/creation/photo/camera/v;->i(Lcom/instagram/creation/photo/camera/v;)I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/instagram/camera/f;->c(I)Z
    ...
    invoke-virtual {v0}, Lcom/instagram/creation/photo/camera/v;->getContext()Landroid/content/Context;
    ...
    invoke-static {v4}, Lcom/instagram/creation/photo/camera/v;->v(Lcom/instagram/creation/photo/camera/v;)Lcom/instagram/creation/photo/camera/x;
    ...
    invoke-virtual {v1, v4, v3, v2}, Lcom/instagram/creation/base/a/e;->a(Lcom/instagram/creation/base/CropInfo;ZI)V

    .line 1510
    :cond_2
    iget-object v1, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;

    invoke-static {v1}, Lcom/instagram/creation/photo/camera/v;->a(Lcom/instagram/creation/photo/camera/v;)Ljava/lang/Object;
    ...
    .line 1511
    :try_start_0
    iget-object v2, p0, Lcom/instagram/creation/photo/camera/q;->a:Lcom/instagram/creation/photo/camera/v;
    ...
    invoke-interface {v0}, Lcom/instagram/creation/photo/camera/s;->a()V
