...
.field private b:Lcom/facebook/login/l;
...
.method public constructor <init>(Lcom/facebook/login/LoginClient;)V
    ...
    .line 24
    iput-object p1, p0, Lcom/facebook/login/b;->a:Lcom/facebook/login/LoginClient;

    .line 25
    iput-object p1, p0, Lcom/facebook/login/b;->b:Lcom/facebook/login/l;
...
.method private a(Lcom/facebook/login/LoginClient$Request;Landroid/content/Intent;)Lcom/facebook/login/LoginClient$Result;
    ...
    invoke-static {v0, v3, v2, v4}, Lcom/facebook/login/LoginClient;->a(Ljava/util/Collection;Landroid/os/Bundle;Lcom/facebook/h;Ljava/lang/String;)Lcom/facebook/AccessToken;
    ...
    .line 95
    :cond_2
    sget-object v3, Lcom/facebook/k/p;->a:Ljava/util/Collection;
    ...
    .line 97
    :cond_3
    sget-object v3, Lcom/facebook/k/p;->b:Ljava/util/Collection;
    ...
    .line 100
    :cond_4
    invoke-static {p1, v0, v2, v4}, Lcom/facebook/login/LoginClient$Result;->a(Lcom/facebook/login/LoginClient$Request;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/login/LoginClient$Result;
...
.method protected a(Landroid/content/Intent;I)V
    ...
    .line 106
    iget-object v0, p0, Lcom/facebook/login/b;->b:Lcom/facebook/login/l;

    invoke-interface {v0}, Lcom/facebook/login/l;->a()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/login/b;->a:Lcom/facebook/login/LoginClient;

    invoke-virtual {v0}, Lcom/facebook/login/LoginClient;->d()Landroid/support/v4/app/Fragment;
...
.method public a(Lcom/facebook/login/LoginClient$Request;)V
    ...
    .line 31
    iget-object v1, p0, Lcom/facebook/login/b;->a:Lcom/facebook/login/LoginClient;

    invoke-virtual {v1}, Lcom/facebook/login/LoginClient;->e()Landroid/support/v4/app/x;
    ...
    invoke-static {v1, v2, v3, v0, v4}, Lcom/facebook/k/o;->a(Landroid/content/Context;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/facebook/login/b;->a(Landroid/content/Intent;I)V
...
.method public a(IILandroid/content/Intent;)Z
    ...
    .line 65
    iget-object v1, p0, Lcom/facebook/login/b;->b:Lcom/facebook/login/l;
    ...
    .line 61
    :cond_2
    invoke-direct {p0, v0, p3}, Lcom/facebook/login/b;->a(Lcom/facebook/login/LoginClient$Request;Landroid/content/Intent;)Lcom/facebook/login/LoginClient$Result;
