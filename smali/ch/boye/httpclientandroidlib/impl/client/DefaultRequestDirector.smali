...
.method public constructor <init>(Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;Lch/boye/httpclientandroidlib/conn/routing/HttpRoutePlanner;Lch/boye/httpclientandroidlib/protocol/HttpProcessor;Lch/boye/httpclientandroidlib/client/HttpRequestRetryHandler;Lch/boye/httpclientandroidlib/client/RedirectStrategy;Lch/boye/httpclientandroidlib/client/AuthenticationHandler;Lch/boye/httpclientandroidlib/client/AuthenticationHandler;Lch/boye/httpclientandroidlib/client/UserTokenHandler;Lch/boye/httpclientandroidlib/params/HttpParams;)V
    .locals 4
    .param p1, "log"    # Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;
    .param p2, "requestExec"    # Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;
    .param p3, "conman"    # Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;
    .param p4, "reustrat"    # Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;
    .param p5, "kastrat"    # Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;
    .param p6, "rouplan"    # Lch/boye/httpclientandroidlib/conn/routing/HttpRoutePlanner;
    .param p7, "httpProcessor"    # Lch/boye/httpclientandroidlib/protocol/HttpProcessor;
    .param p8, "retryHandler"    # Lch/boye/httpclientandroidlib/client/HttpRequestRetryHandler;
    .param p9, "redirectStrategy"    # Lch/boye/httpclientandroidlib/client/RedirectStrategy;
    .param p10, "targetAuthHandler"    # Lch/boye/httpclientandroidlib/client/AuthenticationHandler;
    .param p11, "proxyAuthHandler"    # Lch/boye/httpclientandroidlib/client/AuthenticationHandler;
    .param p12, "userTokenHandler"    # Lch/boye/httpclientandroidlib/client/UserTokenHandler;
    .param p13, "params"    # Lch/boye/httpclientandroidlib/params/HttpParams;
...
.method public constructor <init>(Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;Lch/boye/httpclientandroidlib/conn/routing/HttpRoutePlanner;Lch/boye/httpclientandroidlib/protocol/HttpProcessor;Lch/boye/httpclientandroidlib/client/HttpRequestRetryHandler;Lch/boye/httpclientandroidlib/client/RedirectHandler;Lch/boye/httpclientandroidlib/client/AuthenticationHandler;Lch/boye/httpclientandroidlib/client/AuthenticationHandler;Lch/boye/httpclientandroidlib/client/UserTokenHandler;Lch/boye/httpclientandroidlib/params/HttpParams;)V
    .locals 15
    .param p1, "requestExec"    # Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;
    .param p2, "conman"    # Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;
    .param p3, "reustrat"    # Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;
    .param p4, "kastrat"    # Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;
    .param p5, "rouplan"    # Lch/boye/httpclientandroidlib/conn/routing/HttpRoutePlanner;
    .param p6, "httpProcessor"    # Lch/boye/httpclientandroidlib/protocol/HttpProcessor;
    .param p7, "retryHandler"    # Lch/boye/httpclientandroidlib/client/HttpRequestRetryHandler;
    .param p8, "redirectHandler"    # Lch/boye/httpclientandroidlib/client/RedirectHandler;
    .param p9, "targetAuthHandler"    # Lch/boye/httpclientandroidlib/client/AuthenticationHandler;
    .param p10, "proxyAuthHandler"    # Lch/boye/httpclientandroidlib/client/AuthenticationHandler;
    .param p11, "userTokenHandler"    # Lch/boye/httpclientandroidlib/client/UserTokenHandler;
    .param p12, "params"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method private invalidateAuthIfSuccessful(Lch/boye/httpclientandroidlib/auth/AuthState;)V
    .locals 2
    .param p1, "authState"    # Lch/boye/httpclientandroidlib/auth/AuthState;
...
.method private processChallenges(Ljava/util/Map;Lch/boye/httpclientandroidlib/auth/AuthState;Lch/boye/httpclientandroidlib/client/AuthenticationHandler;Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpContext;)V
    .locals 3
    .param p2, "authState"    # Lch/boye/httpclientandroidlib/auth/AuthState;
    .param p3, "authHandler"    # Lch/boye/httpclientandroidlib/client/AuthenticationHandler;
    .param p4, "response"    # Lch/boye/httpclientandroidlib/HttpResponse;
    .param p5, "context"    # Lch/boye/httpclientandroidlib/protocol/HttpContext;
...
.method private tryConnect(Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)V
    .locals 6
    .param p1, "req"    # Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
...
.method private updateAuthState(Lch/boye/httpclientandroidlib/auth/AuthState;Lch/boye/httpclientandroidlib/HttpHost;Lch/boye/httpclientandroidlib/client/CredentialsProvider;)V
    .locals 6
    .param p1, "authState"    # Lch/boye/httpclientandroidlib/auth/AuthState;
    .param p2, "host"    # Lch/boye/httpclientandroidlib/HttpHost;
    .param p3, "credsProvider"    # Lch/boye/httpclientandroidlib/client/CredentialsProvider;
...
.method private wrapRequest(Lch/boye/httpclientandroidlib/HttpRequest;)Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;
    ...
    .restart local p1    # "request":Lch/boye/httpclientandroidlib/HttpRequest;
    :cond_0
...
.method protected createConnectRequest(Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/HttpRequest;
    .locals 4
    .param p1, "route"    # Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;
    .param p2, "context"    # Lch/boye/httpclientandroidlib/protocol/HttpContext;
...
.method protected determineRoute(Lch/boye/httpclientandroidlib/HttpHost;Lch/boye/httpclientandroidlib/HttpRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;
    .locals 2
    .param p1, "target"    # Lch/boye/httpclientandroidlib/HttpHost;
    .param p2, "request"    # Lch/boye/httpclientandroidlib/HttpRequest;
    .param p3, "context"    # Lch/boye/httpclientandroidlib/protocol/HttpContext;
    ...
    .end local p1    # "target":Lch/boye/httpclientandroidlib/HttpHost;
    check-cast p1, Lch/boye/httpclientandroidlib/HttpHost;

    .line 716
    .restart local p1    # "target":Lch/boye/httpclientandroidlib/HttpHost;
    :cond_0
    if-nez p1, :cond_1
...
.method public execute(Lch/boye/httpclientandroidlib/HttpHost;Lch/boye/httpclientandroidlib/HttpRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/HttpResponse;
    ...
    const-string v0, "LOGGING Default Req Dir execute"

    invoke-static {v0, v0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    move-object/from16 v0, p2

    invoke-direct {p0, v0}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->wrapRequest(Lch/boye/httpclientandroidlib/HttpRequest;)Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;
    ...
    invoke-virtual {v3, v2}, Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;->setParams(Lch/boye/httpclientandroidlib/params/HttpParams;)V
    ...
    invoke-virtual {p0, v0, v3, v1}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->determineRoute(Lch/boye/httpclientandroidlib/HttpHost;Lch/boye/httpclientandroidlib/HttpRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;

    move-result-object v4

    .line 360
    invoke-interface/range {p2 .. p2}, Lch/boye/httpclientandroidlib/HttpRequest;->getParams()Lch/boye/httpclientandroidlib/params/HttpParams;

    move-result-object v2

    const-string v5, "http.virtual-host"

    invoke-interface {v2, v5}, Lch/boye/httpclientandroidlib/params/HttpParams;->getParameter(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 364
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->virtualHost:Lch/boye/httpclientandroidlib/HttpHost;
    ...
    .line 366
    invoke-virtual/range {p1 .. p1}, Lch/boye/httpclientandroidlib/HttpHost;->getPort()I
    ...
    invoke-direct {v5, v6, v2, v7}, Lch/boye/httpclientandroidlib/HttpHost;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v5, v3, v4}, Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;-><init>(Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;)V
    ...
    invoke-interface {v0, v2}, Lch/boye/httpclientandroidlib/protocol/HttpContext;->getAttribute(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 393
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->connManager:Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;

    invoke-interface {v2, v7, v8}, Lch/boye/httpclientandroidlib/conn/ClientConnectionManager;->requestConnection(Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;Ljava/lang/Object;)Lch/boye/httpclientandroidlib/conn/ClientConnectionRequest;
    ...
    instance-of v2, v0, Lch/boye/httpclientandroidlib/client/methods/AbortableHttpRequest;
    ...
    invoke-interface {v2, v9}, Lch/boye/httpclientandroidlib/client/methods/AbortableHttpRequest;->setConnectionRequest(Lch/boye/httpclientandroidlib/conn/ClientConnectionRequest;)V

    .line 399
    :cond_1
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->params:Lch/boye/httpclientandroidlib/params/HttpParams;

    invoke-static {v2}, Lch/boye/httpclientandroidlib/conn/params/ConnManagerParams;->getTimeout(Lch/boye/httpclientandroidlib/params/HttpParams;)J
    :try_end_0
    ...
    invoke-interface {v9, v10, v11, v2}, Lch/boye/httpclientandroidlib/conn/ClientConnectionRequest;->getConnection(JLjava/util/concurrent/TimeUnit;)Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;

    move-result-object v2

    iput-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->managedConn:Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;
    :try_end_1
    ...
    invoke-static {v2}, Lch/boye/httpclientandroidlib/params/HttpConnectionParams;->isStaleCheckingEnabled(Lch/boye/httpclientandroidlib/params/HttpParams;)Z
    ...
    invoke-interface {v2}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->isOpen()Z
    ...
    invoke-virtual {v2, v9}, Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V

    .line 412
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->managedConn:Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;

    invoke-interface {v2}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->isStale()Z
    ...
    invoke-interface {v2}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->close()V
    ...
    iget-object v9, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->managedConn:Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;

    invoke-interface {v2, v9}, Lch/boye/httpclientandroidlib/client/methods/AbortableHttpRequest;->setReleaseTrigger(Lch/boye/httpclientandroidlib/conn/ConnectionReleaseTrigger;)V
    :try_end_2
    ...
    invoke-direct {p0, v4, v0}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->tryConnect(Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)V
    :try_end_3
    ...
    .line 438
    invoke-virtual {p0, v5, v7}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->rewriteRequestURI(Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;)V

    .line 441
    iget-object v0, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->virtualHost:Lch/boye/httpclientandroidlib/HttpHost;
    ...
    .line 444
    invoke-virtual {v7}, Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;->getTargetHost()Lch/boye/httpclientandroidlib/HttpHost;

    move-result-object p1

    .line 447
    :cond_4
    invoke-virtual {v7}, Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;->getProxyHost()Lch/boye/httpclientandroidlib/HttpHost;
    ...
    invoke-interface {v0, v7, v1}, Lch/boye/httpclientandroidlib/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v7, v2}, Lch/boye/httpclientandroidlib/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v2, v7}, Lch/boye/httpclientandroidlib/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v5, v7, v0}, Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;->preProcess(Lch/boye/httpclientandroidlib/HttpRequest;Lch/boye/httpclientandroidlib/protocol/HttpProcessor;Lch/boye/httpclientandroidlib/protocol/HttpContext;)V

    .line 464
    move-object/from16 v0, p3

    invoke-direct {p0, v4, v0}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->tryExecute(Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/HttpResponse;
    ...
    invoke-virtual {v2}, Lch/boye/httpclientandroidlib/impl/client/TunnelRefusedException;->getMessage()Ljava/lang/String;
    ...
    .line 430
    :cond_5
    invoke-virtual {v2}, Lch/boye/httpclientandroidlib/impl/client/TunnelRefusedException;->getResponse()Lch/boye/httpclientandroidlib/HttpResponse;
    ...
    invoke-interface {v3}, Lch/boye/httpclientandroidlib/HttpEntity;->isStreaming()Z
    ...
    invoke-interface {v3}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->markReusable()V
    ...
    invoke-interface {v5, v2}, Lch/boye/httpclientandroidlib/HttpResponse;->setParams(Lch/boye/httpclientandroidlib/params/HttpParams;)V
    ...
    invoke-virtual {v2, v5, v6, v0}, Lch/boye/httpclientandroidlib/protocol/HttpRequestExecutor;->postProcess(Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpProcessor;Lch/boye/httpclientandroidlib/protocol/HttpContext;)V

    .line 476
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->reuseStrategy:Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;

    move-object/from16 v0, p3

    invoke-interface {v2, v5, v0}, Lch/boye/httpclientandroidlib/ConnectionReuseStrategy;->keepAlive(Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Z
    ...
    .line 479
    iget-object v2, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->keepAliveStrategy:Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;

    move-object/from16 v0, p3

    invoke-interface {v2, v5, v0}, Lch/boye/httpclientandroidlib/conn/ConnectionKeepAliveStrategy;->getKeepAliveDuration(Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpContext;)J
    ...
    invoke-virtual {v7, v2}, Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v10, v11, v7}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->setIdleDuration(JLjava/util/concurrent/TimeUnit;)V

    .line 492
    :cond_b
    move-object/from16 v0, p3

    invoke-virtual {p0, v4, v5, v0}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->handleResponse(Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
    ...
    .line 516
    iget-object v4, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->userTokenHandler:Lch/boye/httpclientandroidlib/client/UserTokenHandler;

    move-object/from16 v0, p3

    invoke-interface {v4, v0}, Lch/boye/httpclientandroidlib/client/UserTokenHandler;->getUserToken(Lch/boye/httpclientandroidlib/protocol/HttpContext;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v7, v4}, Lch/boye/httpclientandroidlib/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v7, v4}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->setState(Ljava/lang/Object;)V
    ...
    invoke-interface {v7}, Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;->close()V

    .line 505
    iget-object v7, p0, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->proxyAuthState:Lch/boye/httpclientandroidlib/auth/AuthState;

    invoke-direct {p0, v7}, Lch/boye/httpclientandroidlib/impl/client/DefaultRequestDirector;->invalidateAuthIfSuccessful(Lch/boye/httpclientandroidlib/auth/AuthState;)V
    ...
    .line 536
    new-instance v4, Lch/boye/httpclientandroidlib/conn/BasicManagedEntity;
    ...
    invoke-direct {v4, v3, v5, v6}, Lch/boye/httpclientandroidlib/conn/BasicManagedEntity;-><init>(Lch/boye/httpclientandroidlib/HttpEntity;Lch/boye/httpclientandroidlib/conn/ManagedClientConnection;Z)V

    .line 537
    invoke-interface {v2, v4}, Lch/boye/httpclientandroidlib/HttpResponse;->setEntity(Lch/boye/httpclientandroidlib/HttpEntity;)V
    :try_end_6
...
.method protected handleResponse(Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;Lch/boye/httpclientandroidlib/HttpResponse;Lch/boye/httpclientandroidlib/protocol/HttpContext;)Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
    .locals 9
    .param p1, "roureq"    # Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
    .param p2, "response"    # Lch/boye/httpclientandroidlib/HttpResponse;
    .param p3, "context"    # Lch/boye/httpclientandroidlib/protocol/HttpContext;
    ...
    .end local p1    # "roureq":Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
    ...
    .line 1073
    .restart local p1    # "roureq":Lch/boye/httpclientandroidlib/impl/client/RoutedRequest;
    :cond_4
    const-string v0, "http.auth.credentials-provider"
...
.method protected rewriteRequestURI(Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;)V
    .locals 4
    .param p1, "request"    # Lch/boye/httpclientandroidlib/impl/client/RequestWrapper;
    .param p2, "route"    # Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;
