...
.method public constructor <init>(Lch/boye/httpclientandroidlib/impl/client/ClientParamsStack;)V
    .locals 4
    .param p1, "stack"    # Lch/boye/httpclientandroidlib/impl/client/ClientParamsStack;
...
.method public constructor <init>(Lch/boye/httpclientandroidlib/impl/client/ClientParamsStack;Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;)V
    .locals 0
    .param p1, "stack"    # Lch/boye/httpclientandroidlib/impl/client/ClientParamsStack;
    .param p2, "aparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p3, "cparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p4, "rparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p5, "oparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;

    .prologue
    .line 137
    if-eqz p2, :cond_0

    .end local p2    # "aparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    :goto_0
    if-eqz p3, :cond_1

    .end local p3    # "cparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    :goto_1
    if-eqz p4, :cond_2

    .end local p4    # "rparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    :goto_2
    if-eqz p5, :cond_3

    .end local p5    # "oparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    :goto_3
    ...
    .line 137
    .restart local p2    # "aparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    .restart local p3    # "cparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    .restart local p4    # "rparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    .restart local p5    # "oparams":Lch/boye/httpclientandroidlib/params/HttpParams;
    :cond_0
    invoke-virtual {p1}, Lch/boye/httpclientandroidlib/impl/client/ClientParamsStack;->getApplicationParams()Lch/boye/httpclientandroidlib/params/HttpParams;
...
.method public constructor <init>(Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;Lch/boye/httpclientandroidlib/params/HttpParams;)V
    .locals 0
    .param p1, "aparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p2, "cparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p3, "rparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
    .param p4, "oparams"    # Lch/boye/httpclientandroidlib/params/HttpParams;
