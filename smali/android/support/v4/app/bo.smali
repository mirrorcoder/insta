...
.field m:Landroid/support/v4/app/bz;
...
.method public a()Landroid/app/Notification;
    ...
    .prologue
    .line 1532
    invoke-static {}, Landroid/support/v4/app/ca;->a()Landroid/support/v4/app/bq;

    move-result-object v0

    invoke-interface {v0, p0}, Landroid/support/v4/app/bq;->a(Landroid/support/v4/app/bo;)Landroid/app/Notification;
...
.method public a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/support/v4/app/bo;
    .locals 2

    .prologue
    .line 1432
    iget-object v0, p0, Landroid/support/v4/app/bo;->u:Ljava/util/ArrayList;

    new-instance v1, Landroid/support/v4/app/bl;

    invoke-direct {v1, p1, p2, p3}, Landroid/support/v4/app/bl;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method public a(Landroid/support/v4/app/bz;)Landroid/support/v4/app/bo;
    .locals 1

    .prologue
    .line 1464
    iget-object v0, p0, Landroid/support/v4/app/bo;->m:Landroid/support/v4/app/bz;

    if-eq v0, p1, :cond_0

    .line 1465
    iput-object p1, p0, Landroid/support/v4/app/bo;->m:Landroid/support/v4/app/bz;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/bz;->a(Landroid/support/v4/app/bo;)V
...
.method public b(I)Landroid/support/v4/app/bo;
    ...
    .prologue
    .line 1014
    iput p1, p0, Landroid/support/v4/app/bo;->i:I

    .line 1015
    return-object p0
.end method

.method public b(Landroid/app/PendingIntent;)Landroid/support/v4/app/bo;
    .locals 1
...
.method public b(Ljava/lang/CharSequence;)Landroid/support/v4/app/bo;
    ...
    iput-object v0, p0, Landroid/support/v4/app/bo;->c:Ljava/lang/CharSequence;
...
.method public b(Z)Landroid/support/v4/app/bo;
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/bo;->a(IZ)V

    .line 1217
    return-object p0
.end method

.method public c(I)Landroid/support/v4/app/bo;
    .locals 2
...
.method public c(Ljava/lang/CharSequence;)Landroid/support/v4/app/bo;
    .locals 2
...
.method public c(Z)Landroid/support/v4/app/bo;
    .locals 1
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/bo;->v:Z

    .line 1228
    return-object p0
.end method

.method public d(I)Landroid/support/v4/app/bo;
    .locals 0

    .prologue
    .line 1287
    iput p1, p0, Landroid/support/v4/app/bo;->j:I
