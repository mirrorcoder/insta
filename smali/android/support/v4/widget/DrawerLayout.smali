...
.field private final d:Landroid/support/v4/widget/a;
...
.field private final i:Landroid/support/v4/widget/ai;

.field private final j:Landroid/support/v4/widget/ai;

.field private final k:Landroid/support/v4/widget/h;

.field private final l:Landroid/support/v4/widget/h;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bd;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;
    ...
    .line 482
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ai;
...
.method a(IILandroid/view/View;)V
    ...
    .line 611
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;

    invoke-virtual {v2}, Landroid/support/v4/widget/ai;->a()I

    move-result v2

    .line 612
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ai;

    invoke-virtual {v3}, Landroid/support/v4/widget/ai;->a()I
    ...
    .line 635
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/e;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/e;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/e;->a(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    .line 1265
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/ai;->a(Landroid/view/View;II)Z
    ...
    .line 1268
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ai;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/ai;->a(Landroid/view/View;II)Z
    ...
    .line 1275
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/h;

    invoke-virtual {v0}, Landroid/support/v4/widget/h;->a()V

    .line 1276
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/h;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1568
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/a;
...
.method b(Landroid/view/View;)V
    ...
    .line 643
    iget-boolean v1, v0, Landroid/support/v4/widget/f;->d:Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/e;->b(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/e;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/ai;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ai;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/ai;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ai;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/ai;->b()I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/f;-><init>(II)V
...
.method public h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/ai;->a(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1137
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/ai;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ai;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/ai;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1149
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/ai;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/ai;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/bd;->o(Landroid/view/View;)Z
    ...
    .line 854
    iget v8, v0, Landroid/support/v4/widget/f;->a:I

    invoke-static {v8, v5}, Landroid/support/v4/view/q;->a(II)I

    move-result v8

    .line 855
    invoke-static {v7}, Landroid/support/v4/view/bd;->o(Landroid/view/View;)Z
    ...
    .line 864
    iget v8, v0, Landroid/support/v4/widget/f;->leftMargin:I

    sub-int v8, v2, v8

    iget v9, v0, Landroid/support/v4/widget/f;->rightMargin:I
    ...
    .line 866
    iget v9, v0, Landroid/support/v4/widget/f;->topMargin:I
    ...
    iget v9, v0, Landroid/support/v4/widget/f;->leftMargin:I
    ...
    iget v9, v0, Landroid/support/v4/widget/f;->width:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1202
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ai;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/ai;->d(II)Landroid/view/View;
...
.method public setDrawerListener(Landroid/support/v4/widget/e;)V
    .locals 0
    .param p1, "listener"    # Landroid/support/v4/widget/e;

    .prologue
    .line 432
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/e;
